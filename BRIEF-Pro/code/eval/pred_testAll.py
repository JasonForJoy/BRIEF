...
def parse_args(args=None):
    ...
    parser.add_argument('--model', type=str, default=None, choices=["llama2-7b-chat-4k", "longchat-v1.5-7b-32k", "xgen-7b-8k", "internlm-7b-8k", "chatglm2-6b", "chatglm2-6b-32k", "chatglm3-6b-32k", "vicuna-v1.5-7b-16k","llama3.1-8b-instruct-128k","film-7b-32k", "llama3.1-70B-instruct-128k"])
...
def get_pred(rank, world_size, data, max_length, max_gen, prompt_format, dataset, device, model_name, model2path, out_path):
    ...
    for json_obj in tqdm(data):
        ...
        with open(out_path, "a", encoding="utf-8") as f:
            ...
            json.dump({"pred": pred, "answers": json_obj["answers"]}, f, ensure_ascii=False)
...
def load_model_and_tokenizer(path, model_name, device):
    if "chatglm" in model_name or "internlm" in model_name or "xgen" in model_name:
        ...
        if model_name == "llama3.1-70B-instruct-128k":
...
if __name__ == '__main__':
    ...
    if args.e:
        ...
        # datasets = ["musique_dev_ExpandTop20_Final_500"]

        # datasets = ["musique_dev_Final_500"]

        # datasets = ["musique_dev_ExpandTop40_Final_500", "musique_dev_ExpandTop60_Final_500", "musique_dev_ExpandTop80_Final_500"]
