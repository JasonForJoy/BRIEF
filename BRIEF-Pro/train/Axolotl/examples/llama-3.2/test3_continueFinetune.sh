...
axolotl_cfgs=(
    ...
    # "/data2/junyizhang/BRIEF_train_eval_Code/Axolotl/examples/llama-3.2/series/datasets/factory/My_instruct-lora-3b-ep3-lr0_0001-sent_cont_local_wiki_longer_8_singlehop_filterRepeat_continueFinetune.yml"

    # "/data2/junyizhang/BRIEF_train_eval_Code/Axolotl/examples/llama-3.2/series/datasets/factory/My_instruct-lora-3b-ep3-lr0_0001-Qasper_UserControl_continueFinetune.yml"

    # "/data2/junyizhang/BRIEF_train_eval_Code/Axolotl/examples/llama-3.2/series/datasets/factory/My_instruct-lora-3b-ep3-lr0_0001-LongAlign_UserControl_continueFinetune.yml"

    # "/data2/junyizhang/BRIEF_train_eval_Code/Axolotl/examples/llama-3.2/series/datasets/factory/My_instruct-lora-3b-ep3-lr0_0001-LongAlign_GPToracle_UserControl_continueFinetune.yml"
...
while :; do
  ...
  if [[ $all_free == true ]]; then
    ...
    for cfg in "${axolotl_cfgs[@]}"; do
        ...
        # CUDA_VISIBLE_DEVICES=3,5 accelerate launch --main_process_port 29523 -m axolotl.cli.train "$cfg" 2>&1 | while IFS= read -r line; do

        CUDA_VISIBLE_DEVICES=4,5 accelerate launch -m axolotl.cli.train "$cfg" 2>&1 | while IFS= read -r line; do

        # CUDA_VISIBLE_DEVICES=3,5 accelerate launch -m axolotl.cli.train --resume-from-checkpoint /data2/junyizhang/BRIEF_train_eval_Code/Axolotl/outputs/My_finetune_MuSiqQue_x4_UserControl/checkpoint-654 "$cfg" 2>&1 | while IFS= read -r line; do
