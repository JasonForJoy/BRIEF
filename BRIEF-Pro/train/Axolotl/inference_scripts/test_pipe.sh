...
ALLOW_NUM_GPU="2"
SETTINGS=(
    "My_Axolotl_Finetuned_MuSiqQue_x4_Yuankai"
    )
MERGE_PATHS=(
    ...
    # "/data2/junyizhang/BRIEF_train_eval_Code/Axolotl/outputs/lora-out-ins-epoch3-lr0_0001-sent_wikifull_8longer_fixed/merged"
    "/data2/junyizhang/BRIEF_train_eval_Code/Axolotl/outputs/My_finetune_MuSiqQue_x4_Final_merged"
    )
