...
ALLOW_NUM_GPU="2"
SETTINGS=(
    "My_Axolotl_Finetuned_MuSiqQue_x4_UserControl_Final_15sentences_222"
...
for i in "${!SETTINGS[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES="${ALLOW_GPUS}" python /data2/junyizhang/BRIEF_train_eval_Code/Axolotl/inference_scripts/vllm_compression_longbench_UserControl.py --name "${SETTING}" --model_path "${MERGE_PATH}" --parallel_size "${ALLOW_NUM_GPU}"
