...
for i in "${!SETTINGS[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES="${ALLOW_GPUS}" python /data2/junyizhang/BRIEF_train_eval_Code/LongBench/LongBench/pred_noCompress_testLVEval.py --model "llama3.1-8b-instruct-128k" --e --setting "${SETTING}"
