...
ALLOW_NUM_GPU="2"
SETTINGS=(
    "My_Axolotl_Finetuned_MusiqueX8_HotpotX10_Mix_normDistribution_controlDisMain10000_UserControl_checkpoint891_5sentences_testAll"
    # "My_Axolotl_Finetuned_MusiqueX8_HotpotX10_Mix_normDistribution_controlDisMain10000_UserControl_checkpoint891_Auto_testAll"
    )
MERGE_PATHS=(
    ...
    "/data2/junyizhang/BRIEF_train_eval_Code/Axolotl/outputs/My_finetune_MusiqueX8_HotpotX10_Mix_normDistribution_controlDisMain10000_UserControl_merged_checkpoint891"
    )
...
for i in "${!SETTINGS[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES="${ALLOW_GPUS}" python /data2/junyizhang/BRIEF_train_eval_Code/Axolotl/inference_scripts/vllm_compression_longbench_testLooGLE_UserControl.py --name "${SETTING}" --model_path "${MERGE_PATH}" --parallel_size "${ALLOW_NUM_GPU}"
    ...
    CUDA_VISIBLE_DEVICES="${ALLOW_GPUS}" python /data2/junyizhang/BRIEF_train_eval_Code/LongBench/LongBench/pred_testLooGLE.py --model "llama3.1-8b-instruct-128k" --e --setting "${SETTING}"
    ...
    python /data2/junyizhang/BRIEF_train_eval_Code/LongBench/LongBench/eval_LooGLE.py --model "llama3.1-8b-instruct-128k_${SETTING}"
