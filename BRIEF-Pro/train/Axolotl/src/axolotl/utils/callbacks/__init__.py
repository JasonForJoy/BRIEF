        ...
        def __maybe_load_metrics(self):
            ...
            for metric in self.cfg.eval_causal_lm_metrics:
                if metric == "perplexity":
                    ...
                    try:
                        LOG.info(f"1 Successfully loaded")
                        # metrics[metric] = evaluate.load(metric)
                        metrics[metric] = datasets.load_metric(metric,cache_dir="/home/jcgu/.cache/huggingface/modules/datasets_modules/metrics")
                ...
                for batch in tqdm(eval_dataloader):
                    ...
                    for input_ids_all, labels_all, pos_ids in zip(
                        ...
                        for pos_range in pos_ranges:
                            ...
                            completion_token_includes = (
                                tokens_with_loss & tokens_exclude_padding
                            )
                            completion_token_ids = input_ids[completion_token_includes]
